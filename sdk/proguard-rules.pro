...
##pando code proguard
# -keep class com.pandocloud.android.config.handler.GateWayMsgHandler { *; }
-keep class com.pandocloud.android.config.wifi.WifiConfigManager { *; }
-keep class com.pandocloud.android.config.wifi.WifiConfigMessageHandler { *; }
-keep class com.pandocloud.android.api.AbsOpenApi { *; }
-keep class com.pandocloud.android.api.DeviceState { *; }
-keep class com.pandocloud.android.api.DeviceState$* { *; }
-keep class com.pandocloud.android.api.interfaces.** { *; }
-keep class com.pandocloud.android.api.DeviceLoginManager { *; }

-keep class com.pandocloud.android.utils.WifiConnectUtil { *; }
-keep class com.pandocloud.android.utils.WifiConnectUtil$*{
     *;
}
-keep class com.pandocloud.android.utils.NetworkUtil { *; }